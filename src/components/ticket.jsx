...
export default function Ticket({type, amount, id, setSelectedTicket, selectedTicket}) {
  ...
  return (
    <button onClick={(e)=>{clickAction(e)}} className={` ${id === selectedTicket? "bg-[#12464E] border-[#197686] border-[1px]" : "bg-none border-[#197686]"} hover:bg-[#2C545B] font-roboto w-full lg:w-[158px] border-[2px] border-[#197686] rounded-[12px] gap-[12px] h-[110px] gap-[8px] p-[8px] flex-col flex`}>
