...
export default function Button({clickAction, text, type}) {
  ...
  return (
    type === "accent"? 
    <button onClick={(e)=>{action(e)}} type='submit' className='btn py-[12px] rounded-[8px] h-[48px] text-[white] hover:bg-[#2C545B] bg-[#24A0B5] px-[24px] w-full border-[#24A0B5] border-[1px]'>{text}</button>:
